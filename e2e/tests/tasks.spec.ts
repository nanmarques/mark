...
test.describe('cadastro', () => {
    ...
    test('campo obrigatório', async ({ request }) => {
        ...
        await tasksPage.go()
        await tasksPage.create(task)
        const validationMessage = await tasksPage.inputTaskName.evaluate(e => (e as HTMLInputElement).validationMessage)  // manipular elemento de alerta do browser, que não é HTML
